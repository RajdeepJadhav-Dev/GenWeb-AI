...
export default function Workspace() {
  ...
  useEffect(() => {
    const fetchMessages = async () => {
      ...
      try {
        const res = await axios.get(`${import.meta.env.VITE_BACKEND_URL}/get/${WorkspaceId}`);
...
async function GetAiResponse(lastUserMessage) {
 setcodeloading(true);
    ...
    try {
      //chat ai response
        const response = await axios.post(`${import.meta.env.VITE_BACKEND_URL}/AiResponse`, { PROMPT });
      //code ai response
      const res = await axios.post(`${import.meta.env.VITE_BACKEND_URL}/AiCodeResponse`,{CodePROMPT:CodePROMPT});
