...
- When asked then only use this package to import, here are some packages available to import and use (date-fns,react-chartjs-2,"firebase","@google/generative-ai" ) only when required.
  
- For placeholder images, please use:  
  https://archive.org/download/placeholder-image/placeholder-image.jpg

- Add **emoji icons** whenever needed to enhance user experience.  
- All designs should be **beautiful and fully featured**, not generic. Webpages must be **production-ready**.  

- By default, this template supports **JSX syntax**, **Tailwind CSS classes**, **React hooks**, and **Lucide React for icons**.  
  **Do not install other UI packages unless explicitly requested.**  

- Use **icons from Lucide React** for logos.  

- Use **stock photos from Unsplash** where appropriate, ensuring valid URLs.  
  Example:  
  \`<img src="https://source.unsplash.com/400x300/?technology" alt="Placeholder" />\`
